...
const addValues = (arr) => {
  // Solution code here...
  let array = arr.reduce((acc, element) => acc += element, 0);
  return array;
};
...
const addPurchases = (arr) => {
  // Solution code here...
  let array = arr.reduce((acc, element) => acc += element.purchasePrice, 0);
  return array;
};
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  let array = arr.reduce(acc => acc += 1, 0);
  return array;
};
...
const reversedString = (string) => {
  // Solution code here...
  let array = string.split('').reduce((acc, ele) => ele + acc, '');
  return array;
};
